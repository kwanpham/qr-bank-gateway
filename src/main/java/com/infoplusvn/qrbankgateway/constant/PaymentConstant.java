...
public class PaymentConstant {
    ...
    public static final String API_URL_SENT_TO_CORE = "http://localhost:8029/issuerbank/qr/v1/issuer/payment";
    public static final String API_URL_SENT_TO_NAPAS = "http://localhost:8029/benbank/qr/v1/issuer/payment";
